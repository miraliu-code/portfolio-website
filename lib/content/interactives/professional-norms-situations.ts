...
const NEGOTIATION_DEFERRAL_NOTE =
  " Significant delta: Swiss and Swedish counterparties often cannot close alone, because the decision is federated across stakeholders or taken back to the group. Treat a Swiss or Swedish 'let me confirm with the team' as genuine process, not a tactic. [Reported]";
...
export const pnCells: Record<string, PnCountryCells> = {
  "united-states": {
    ...
    negotiation: {
      ...
      sequence:
        "Silence after a number is often a tactic, not discomfort, and holding it can extract a better offer. The person across the table frequently has real authority to close. [Well-established]",
      costlyError:
        "Filling silence after stating your number, which concedes value for no reason. [Well-established]",
      disconfirmingSignal:
  ...
  ireland: {
    meeting: {
      ...
      costlyError:
        "Treating the humor as filler and rushing past it, when it's doing real relationship work. [Reported]",
      disconfirmingSignal:
  ...
  australia: {
    ...
    feedback: {
      ...
      costlyError:
        "A senior person visibly punishing someone for direct pushback, which damages their own standing more than the challenger's. [Reported]",
      disconfirmingSignal:
  ...
  germany: {
    meeting: {
      ...
      costlyError:
        "Arriving without having read circulated material, which reads as a lack of seriousness, not a minor oversight. [Well-established]",
      disconfirmingSignal:
    ...
    negotiation: {
      ...
      costlyError:
        "Opening with an aggressively low or high anchor, which can damage credibility for the rest of the negotiation. [Well-established]",
      disconfirmingSignal:
  ...
  switzerland: {
    meeting: {
      ...
      costlyError:
        "Naming other clients or deals to build credibility, which reads as indiscreet. [Reported]",
      disconfirmingSignal:
  ...
  netherlands: {
    meeting: {
      ...
      costlyError:
        "Treating early pushback as a sign the deal is failing, when it usually signals genuine interest. [Well-established]",
      disconfirmingSignal:
        "If the room stays quiet through your full presentation without interjecting, that is the unusual signal here, not the norm; ask directly what they think. [Reported]",
    },
    feedback: {
      upward:
  ...
  china: {
    meeting: {
      ...
      costlyError:
        "Expecting a concrete commitment from this first meeting, which is commonly understood as relationship-building, not closing. [Well-established]",
      disconfirmingSignal:
  ...
  singapore: {
    meeting: {
      baseline: "c",
      baselineNote: "genuine hybrid, reading toward A once formalities are observed",
      delta:
  ...
  uae: {
    meeting: {
      ...
      delta:
        "Relationship-building (extended small talk, questions about wellbeing and family, hospitality over coffee or tea) is not preamble; it is the actual work of the meeting. Rushing to substance too quickly reads as disrespectful. [Well-established]",
      sequence:
  ...
  brazil: {
    meeting: {
      ...
      costlyError:
        "Maintaining typical Anglo physical distance or rushing the personal opening, which reads as cold. [Well-established]",
      disconfirmingSignal:
  ...
  italy: {
    meeting: {
      ...
      costlyError:
        "Treating the personal conversation as preamble to skip past, when it's often doing real relationship work. [Reported]",
      disconfirmingSignal:
