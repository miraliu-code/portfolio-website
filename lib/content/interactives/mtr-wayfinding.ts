...
export const mtrElements: MtrSignElement[] = [
  {
    ...
    says:
      "Which platform serves your direction. The number belongs to this station's architecture, not to the network; the colour still speaks line-language: that red is Tsuen Wan Line red, wherever it appears. One symbol answers two questions: which service, and where to stand.",
    why:
  ...
  },
  {
    ...
    says:
      "The direction, named by LINE: the grammar the system's own route map teaches. It asks you to hold the network in your head: to know which line goes where before the sign can help you.",
    why:
  ...
  },
  {
    ...
    says:
      "A named way out. 'Exit A', subdivided where it matters into A1 and A2, is a destination in its own right, listed on the sign the way places are.",
    why:
      "Leaving is statistically the hardest wayfinding problem in any station, and the MTR's answer is to make exits addressable. A hotel, a colleague, or a meeting invitation can send you to 'Exit B', which moves the hardest navigation work off the sign and into the conversation that happens before the journey starts. The letters do ask something of you: an exit letter is only as useful as the person who told it to you. [Reported]",
  },
  {
    id: "yellow-block",
  ...
  },
  {
    ...
    says:
      "The station and line names in Chinese, set in a Song/Ming-style face, serifed and calligraphy-rooted, in a fixed bilingual rhythm: Chinese above, English below, every sign, everywhere.",
    why:
...
export const mtrModeRestNote =
  "The sign at rest, with no reading mode applied. Choose one to see the same sign consumed three different ways.";
...
export const mtrMosaicIntro =
  "Under the identical concrete architecture of the early system, chief architect Roland Paoletti gave every station a single colour, executed in mosaic tile, a cheap, abundant material in the Hong Kong of the 1970s. The choice was economical first and identity second, and it built the network's most underrated wayfinding layer: you can recognise your stop by sight alone, from a moving train, without reading anything.";
...
export const mtrCitiesIntro =
  "Three dimensions only: how each system names its lines, what its numerals mean, and what its typography carries. That is where the MTR's choices stand out.";
