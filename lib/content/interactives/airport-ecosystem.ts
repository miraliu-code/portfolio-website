...
export const aeZones: AeZone[] = [
  {
    ...
    detail: {
      ...
      informationFlows:
        "Passenger and bag data flows to the airline's system and the security agency's system separately — the two don't always sync in real time, which is why a bag can show as \"checked in\" in the airline's app while still sitting unscreened.",
    },
  },
  {
    id: "security",
    ...
    detail: {
      ...
      painPoints:
        "The line you're standing in moves at a pace set entirely by staffing decisions made somewhere else, on a schedule you have no visibility into — which is why the same checkpoint can be a five-minute wait on Tuesday and a forty-minute wait on Friday with no obvious cause.",
      decisionBottlenecks:
