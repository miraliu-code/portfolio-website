...
export const ptCaptions: Record<PtCityId, Record<PtDimensionId, string>> = {
  ...
  "new-york": {
    ...
    digital: "The baseline the other three stand against: New York's platform announcements are famously utilitarian and, in the popular imagination, half-audible — a comparative impression rather than a measured claim, but the contrast is the point. Tokyo composed its safety audio; London's warning became an icon; New York's remains, recognizably, a PA system. [Reported]",
  },
};
